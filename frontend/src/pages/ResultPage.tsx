...
import type { Assessment, Recommendation } from '../types/api';
...
function ResultPage() {
  ...
  const initialAssessment = (location.state as ResultLocationState | null)?.assessment ?? null;
  ...
  const recommendations: Recommendation[] = diagnoses.flatMap((d) =>
